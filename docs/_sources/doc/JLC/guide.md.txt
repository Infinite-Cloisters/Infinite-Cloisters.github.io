...
如果你打算直接使用CMake完成编译，请参考["VSCode使用CMake编译STM32"](https://blog.csdn.net/qq_42839452/article/details/153870471)，这个其实就是另外一个方案中CLion帮你干的活，选择使用VSCode单纯是为了轻量（CLion软件相对较重），不要下载网盘里面的安装包，去官网上下载新的。
